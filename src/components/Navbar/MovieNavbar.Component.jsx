...
const NavLg = () => {
  return (
    <>
      <div className="container flex items-center mx-auto px-4 justify-between">
        <div className="flex items-center w-1/2 gap-3">
          ...
          <div className="w-full flex gap-3 items-center bg-white px-3 py-1 rounded-md">
            <BiSearch />
            <input
              type="search"
...
const MovieNavbar = () => {
  return (
    <nav className=" bg-white border-b-2 lg:broder-b-0 lg:bg-darkBackground-700 px-4 py-3">
